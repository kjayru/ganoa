	...
	$("a#submit").click(function(){
		...
		$.ajax({
			...
			success: function(){
				$('.error').fadeOut(0);
				$('form#contact-form').clearForm();
				$('#contact_form').html("<div class='download-box'><div><p>Gracias me estare contactondo en la brevedad!</p></div></div>")
					.append("<br><label for='message'><b>&nbsp;.</b></label>")
					.fadeOut(0)
					.fadeIn(1500, function(){
						$('#contact_form').append("<br><br><a href='#' id='back' class='link1' onclick='window.location.reload(); return false;'>Regresar</a>");
						Cufon.refresh();
					});
			}
		});				
